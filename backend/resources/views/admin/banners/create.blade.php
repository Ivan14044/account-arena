...
@section('content_header')
    <div class="content-header-modern">
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-3">
            <div>
                <h1 class="m-0 font-weight-light">Создать рекламный баннер</h1>
                <p class="text-muted mb-0 mt-1 d-none d-md-block">Добавление нового рекламного баннера на сайт</p>
            </div>
                ...
                <div class="tab-content mb-3">
                    ...
                    <div class="tab-pane fade show active" id="ru" role="tabpanel">
                        <div class="form-group">
                            ...
                            @enderror
                            <small class="form-text text-muted">Внутреннее название для управления</small>
                        </div>
                    </div>
