...
@section('content_header')
    <div class="content-header-modern">
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-3">
            <div>
                <h1 class="m-0 font-weight-light">Массовое уведомление</h1>
                <p class="text-muted mb-0 mt-1 d-none d-md-block">Отправка уведомления группе пользователей</p>
            </div>
            <div class="w-100 w-md-auto">
                <a href="{{ route('admin.notifications.index') }}" class="btn btn-secondary btn-modern w-100 w-md-auto">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.notifications.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="d-flex flex-column flex-sm-row gap-2 mt-3">
                            <button type="submit" class="btn btn-primary btn-modern"><i class="fas fa-save mr-2"></i>Отправить уведомления</button>
                            <a href="{{ route('admin.notifications.index') }}" class="btn btn-secondary btn-modern">Отмена</a>
                        </div>
                    </form>
                </div>
            </div>
