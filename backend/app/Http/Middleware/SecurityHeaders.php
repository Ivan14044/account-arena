...
class SecurityHeaders
{
    ...
    private function buildCsp(): string
    {
        ...
        return implode('; ', [
            ...
            "connect-src 'self' {$appUrl} {$frontendUrl} https://api.monobank.ua https://api.cryptomus.com http://cdn.ckeditor.com https://cdn.ckeditor.com http://cdn.datatables.net https://cdn.datatables.net https://static.cloudflareinsights.com",
            "frame-src 'self'",
            "object-src 'none'",
            "base-uri 'self'",
            "form-action 'self'",
