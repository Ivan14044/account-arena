            ...
            >
                ...
                <div class="product-info">
                    <div class="title-with-badge">
                        ...
                        <div class="stock-badge-inline" :class="account.quantity > 0 ? 'in-stock' : 'out-of-stock'">
                            <svg v-if="account.quantity > 0" class="w-3 h-3" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <p v-if="account.description" class="product-description" v-html="account.description"></p>
                </div>
                ...
                <div class="product-actions">
                    ...
                    <div class="top-actions-row">
                        ...
                        <div class="price-section">
                            <div class="price">{{ formatTotalPrice(account.price, getQuantity(account.id)) }}</div>
                            <div class="price-per-unit">{{ $t('account.detail.price_per_unit', { price: formatPrice(account.price), quantity: getQuantity(account.id) }) }}</div>
                        </div>
                    ...
                    <div class="actions-row">
                        ...
                        <button 
                            ...
                            title="В избранное"
                        >
                            <svg class="w-5 h-5" :fill="isFavorite(account.id) ? 'currentColor' : 'none'" stroke="currentColor" viewBox="0 0 24 24">
...
const addToCart = (account: any) => {
    ...
    toast.success(t('account.detail.product_added_to_cart', { title: account.title, quantity: quantity }), {
        position: 'top-right',
        duration: 3000,
    });
