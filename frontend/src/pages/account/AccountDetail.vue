                            ...
                            <div class="lg:col-span-8 flex flex-col">
                                ...
                                >
                                    <div>
                                        ...
                                        <div v-if="additionalDescription" class="additional-description-section mt-6 pt-6 border-t border-gray-100 dark:border-gray-800">
                                            <h3
                                                class="text-base font-semibold text-gray-900 dark:text-white mb-2 flex items-center gap-2"
                                            >
                                                <svg
                                                ...
                                                {{ $t('account.detail.additional_description_title') }}
                                            </h3>
                                            <div
                                                class="text-gray-900 dark:text-gray-300 info-body product-content"
...
const { t } = useI18n();
const { getProductTitle, getProductDescription, getAdditionalDescription } = useProductTitle();
...
const additionalDescription = computed(() => {
    return account.value ? getAdditionalDescription(account.value, true) : '';
});
