    ...
    <div class="max-w-4xl mx-auto px-4 py-16 sm:px-6 lg:px-8 relative z-1">
        ...
        <div class="glass-card rounded-3xl p-6 mb-6">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm text-gray-600 dark:text-gray-400 mb-1">{{ $t('balance_topup.current_balance') }}</p>
                    <p class="text-3xl font-bold text-green-600 dark:text-green-400 flex items-center gap-2">
            ...
            <div class="space-y-3">
                ...
                >
                    <div class="flex items-center gap-3">
                        ...
                        <div class="flex-1">
                            <div class="font-semibold text-gray-900 dark:text-white">{{ $t('balance_topup.payment_card') }}</div>
                            <div class="text-sm text-gray-600 dark:text-gray-400">{{ $t('balance_topup.payment_card_desc') }}</div>
                        </div>
                        <div
                            :class="[
                ...
                >
                    <div class="flex items-center gap-3">
                        ...
                        <div class="flex-1">
                            <div class="font-semibold text-gray-900 dark:text-white">{{ $t('balance_topup.payment_crypto') }}</div>
                            <div class="text-sm text-gray-600 dark:text-gray-400">{{ $t('balance_topup.payment_crypto_desc') }}</div>
                        </div>
                        <div
                            :class="[
                                'w-5 h-5 rounded-full border-2 transition-all duration-200',
        ...
        <!-- Информация -->
        <div class="glass-card rounded-2xl p-5 mb-6 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800">
...
onMounted(async () => {
    ...
    try {
        ...
        console.log('[BALANCE TOPUP] Token:', authStore.token ? authStore.token.substring(0, 20) + '...' : 'отсутствует');
        ...
        console.log('[BALANCE TOPUP] Обновляем данные пользователя для получения актуального баланса...');
        try {
